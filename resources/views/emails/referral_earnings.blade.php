...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml">
  <head>
    ...
    <title>Nouveau gain de parrainage !</title>
    <style>
                ...
                <tr>
                  <td class="text-center text-slate-600 text-xs px-6">
                    ...
                    <p class="cursor-default">
                      <a
                        href="https://www.facebook.com/profile.php?id=61562893141673"
                      ...
                      &bull;
                      <a
                        href="https://www.linkedin.com/company/104114101/"
                        class="[text-decoration:none] hover:![text-decoration:underline]"
                        style="color: red"
                        >LinkedIn</a
                      >
                      &bull;
                      <a
                        href="https://www.instagram.com/iwalinksa"
                        class="[text-decoration:none] hover:![text-decoration:underline]"
                        style="color: red"
                        >Instagram</a
                      >
