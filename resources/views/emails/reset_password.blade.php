                    ...
                    <td style="width: 552px; max-width: 100%">
                        <div class="sm-my-8" style="margin-top: 48px; margin-bottom: 48px; text-align: center">
                            <a href="https://cosinelayer2.com/">
                                <img src="https://cosinelayer2.com/_next/image?url=%2Fcosine.png&w=256&q=75" width="70" alt="" style="max-width: 100%; vertical-align: middle">
                            </a>
                        </div>
                        <table cellpadding="0" cellspacing="0" role="none" style="width: 100%;">
                            <tr>
                                <td class="sm-px-6" style="border-radius: 4px; background-color: #fffffe; padding: 48px; font-size: 16px; color: #334155; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)">
                                    ...
                                    <div role="separator" style="height: 1px; line-height: 1px; margin: 32px 0; background-color: #e2e8f0">
                                        &zwj;
                                    </div>
                                    <p style="margin: 0;">
                            ...
                            <tr>
                                <td style="padding-left: 24px; padding-right: 24px; text-align: center; font-size: 12px; color: #475569">
                                    ...
                                    <p style="cursor: default">
                                        ...
                                        &bull;
                                        <a href="https://www.linkedin.com/company/104114101/" class="hover-important-text-decoration-underline" style="color: red; text-decoration: none;">LinkedIn</a>
                                        &bull;
                                        <a href="https://www.instagram.com/iwalinksa" class="hover-important-text-decoration-underline" style="color: red; text-decoration: none;">Instagram</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
